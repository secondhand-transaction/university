		...
		<div class="row ">
			...
			<div class="col-md-2 wow slideInDown" id="left">
				...
				<ul id="systemSetting"
					...
					<li><li class="active"><a href="cart.jsp" class="ex0 active"><i
			...
			<div class=" col-md-8 publish wow fadeInUp" id="right">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<form action="OrderServlet?GoodsID=${c.goods_id}" method='post'>
								<button type="submit" name="submit" value="deleteOne"
									class="btn col-sm-4 col-md-offset-3" id="expaddbtn">移除</button>
							</form>
						</div>
					</div>
					</br>
				...
				<form action="OrderServlet?" method='post'>
					<c:choose>
						<c:when
							test="${sessionScope.counts > 0 }">
							<div class="form-group">
								<div class="col-sm-2"></div>
								<div class="col-sm-5">

									<button type="submit" name="submit"
										class="btn btn-primary  col-sm-4 col-md-offset-0"
										id="expaddbtn" value="generate">生成订单</button>
								</div>
								<div class="col-sm-4">
									<button type="submit" name="submit"
