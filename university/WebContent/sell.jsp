			...
			<div class="col-md-2 wow slideInDown" id="left">
				...
				<div>
					...
					<ul class="nav nav-pills nav-stacked collapse in " id="userSetting">
						...
						<li class="active"><a href="HistorySeller.doCui"> <i
					...
					<tbody>
						...
						<c:forEach items="${ListGoods}" var="Listgoods">
							<tr>
								...
								<td><c:if test="${Listgoods.getGoods_status() eq '0' || Listgoods.goods_status eq '4'}">正常上架</c:if>
									<c:if test="${Listgoods.getGoods_status() eq '1'}">被举报下架</c:if>
