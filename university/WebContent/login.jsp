...
<div class="row ">
<div class="form ">
<form class="form-horizontal wow slideInDown " action="${pageContext.request.contextPath}/WanghaoServlet?op=login" method="post" onSubmit="return beforeSubmit(this);">
