...
<div class="container-fluid">
  <div class="row wow slideInDown">
    <form class="form-horizontal" action="${pageContext.request.contextPath}/WanghaoServlet?op=signup" method="post"  onSubmit="return beforeSubmit(this);">
...
<script type="text/javascript">
    ...
    function checkUsername(){
        ...
        xmlHttp.onreadystatechange = function(){
            ...
            //创建连接
            xmlHttp.open("GET","${pageContext.request.contextPath}/WanghaoServlet?op=nameAvaliable&&userNumber="+username,true);
