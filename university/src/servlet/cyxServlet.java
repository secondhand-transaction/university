...
public class cyxServlet extends HttpServlet {
    ...
    public void category(HttpServletRequest request, HttpServletResponse response)
		...
		HttpSession session =request.getSession(true);
		List<Goods> goods=null;
        int ct_id = Integer.parseInt(request.getParameter("category_id"));

            	try {
					goods = cyxDao.category(ct_id);
...
//    public void digital(HttpServletRequest request, HttpServletResponse response)
//            throws ServletException, IOException {
//    	request.setCharacterEncoding("UTF-8");  
//        response.setContentType("text/html;charset=UTF-8");
//        response.setHeader( " content-type", "text/html; charset=UTF-8");
