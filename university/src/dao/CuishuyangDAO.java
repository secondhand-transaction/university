...
//					System.out.println("goodsId " + rs.getInt("goods_id"));
	 ...
	 * @return
	 */
	public List<Goods> ListGoods(int user_id) {
	...
	//
//	public void PublishGoos(int user_id, String goods_name, String description, double price) {
//
//		try {
//
//			Connection c = DBHelper.getInstance().getConnection();
...
//	}
	...
	public List<BuyerGoods> BuyerGoods(int user_id) {
	...
	public List<Goods> Goods(int user_id, int start, int cnt) {
		...
		try {
			...
			String sql = "select * from goods where (user_id = ?) order by goods_id desc limit ?,?";
	...
	public Goods showgoods(int goods_id) {
	...
	public void publishgoods(int user_id,String goods_name, String description, double price, int categoryId) {
	...
	public void updateGoods(String goods_name, double price, String description, int goods_id) {
	...
	public void updatesUser(String user_name, String email, int phone, int user_id) {
		...
		try {
			...
			String sql = "update user set user_name = ?, email = ?, phone = ? where user_id = " + user_id;
	...
	public void cancel(int goods_id) {
	...
	public User UserInf(int user_id) {
	...
	public int goods_id(int user_id, String goods_name, double price) {
		...
		try {
			...
			String sql = "select * from goods where user_id = ? and goods_name ="+ "'"+goods_name + "'"+  "and price = ?"; 
...
public void uploadimage(int goods_id, String image) {
		...
		try {
			...
			String sql = "update goods set goods_image = ? where goods_id = " + goods_id;
