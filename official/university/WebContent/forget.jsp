...
<div class="row ">
<div class="form ">
<form class="form-horizontal wow slideInDown " action="${pageContext.request.contextPath}/servlet/WanghaoServlet?op=forgetPassword" method="post" onSubmit="return beforeSubmit(this);">
