...
<div class="row ">
<div class="form ">
<form class="form-horizontal wow slideInDown " action="${pageContext.request.contextPath}/servlet/WanghaoServlet?op=changepassword" method="post" onSubmit="return beforeSubmit(this);">
...
<script type="text/javascript">
    ...
    function checkUsername(){
        ...
        xmlHttp.onreadystatechange = function(){
            ...
            //创建连接
            xmlHttp.open("GET","${pageContext.request.contextPath}/servlet/WanghaoServlet?op=canChange&&id="+userId+"&&key="+PIN,true);
