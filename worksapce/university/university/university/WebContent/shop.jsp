...
<div id="main">
  ...
  <div class="box">
    ...
    <div class="pic"> <a  href="detail.do?goods_id=${good.goods_id}" ><img src="./images/b5.jpg"/> 
    </a>
    </div>
   
    <div class="foot_money "> <span id=price>￥${good.price}</span> <a href="#" class="foot_a"> 
    <span class="glyphicon lyphicon glyphicon-heart-empty">
    <script>
document.write(parseInt(200*Math.random()));</script>
    </span>
    ...
    <div class="foot_title ">
      <p id=p1>商品ID:${good.goods_id}</p><p id=p2> 商品名称:${good.goods_name}<br/></p>
    </div>
    </div>
    </c:forEach>
